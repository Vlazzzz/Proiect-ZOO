	...
	for (unsigned int i = 0; i < JSON["images"].size(); i++)
	{
		...
		if (!skip)
		{
			...
			if (texPath.find("baseColor") != std::string::npos || texPath.find("diffuse") != std::string::npos || 
				texPath.find("grass") != std::string::npos || texPath.find("Tibetan_bear_diffuse") != std::string::npos 
				|| texPath.find("12958_Spider_Monkey_diff") != std::string::npos || texPath.find("fns") != std::string::npos
				|| texPath.find("RoadsDirt0082_1_350") != std::string::npos || texPath.find("wood5") != std::string::npos
				...
				|| texPath.find("10449_Rectangular_Box_Hedge_v1_Diffuse") != std::string::npos)
			{
